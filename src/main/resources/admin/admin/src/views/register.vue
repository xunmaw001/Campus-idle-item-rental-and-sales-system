  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 215, 0, 0.02);borderRadius:20px">
        <h1 class="h1" style="color:rgba(255, 69, 0, 1);fontSize:30px;">校园闲置物品租售系统   注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			   ...
			   <div class="label">卖家号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.maijiahao" class="input" type="text" placeholder="卖家号">
			   </div>
			 </div> -->
			<el-form-item label="卖家号" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiahao" autocomplete="off" placeholder="卖家号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
												...
												<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">卖家名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.maijiaming" class="input" type="text" placeholder="卖家名">
			   </div>
			 </div> -->
			<el-form-item label="卖家名" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiaming" autocomplete="off" placeholder="卖家名" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='maijia'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                  ...
                                                                                                                  if((!this.ruleForm.maijiahao) && `maijia` == this.tableName){
        this.$message.error(`卖家号不能为空`);
        return
      }
        ...
        return
                                                                                                                              ...
                                                                                                                              if(`maijia` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201110/9bf07f14e1ce491cb308bf4d5669690b.jpg");
		height: 100vh;
