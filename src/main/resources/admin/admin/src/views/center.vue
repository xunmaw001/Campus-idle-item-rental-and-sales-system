     ...
     <el-row>
        ...
        <el-form-item v-if="flag=='yonghu'" label="照片" prop="zhaopian">
          ...
          ></file-upload>
                                                ...
                                                <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="卖家号" prop="maijiahao">
          <el-input v-model="ruleForm.maijiahao" readonly              placeholder="卖家号" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="卖家名" prop="maijiaming">
          <el-input v-model="ruleForm.maijiaming"               placeholder="卖家名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        ...
        <el-form-item   v-if="flag=='maijia'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="身份证" prop="shenfenzheng">
  ...
  methods: {
       ...
       this.$message.error(`年龄应输入整数`);
        ...
        return
                                                                                                                  ...
                                                                                                                  if((!this.ruleForm.maijiahao)&& 'maijia'==this.flag){
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.maijiaming)&& 'maijia'==this.flag){
       ...
       this.$message.error(`年龄应输入整数`);
        ...
        return
                                                                        ...
                                                                        if( 'maijia' ==this.flag && this.ruleForm.shenfenzheng&&(!checkIdCard(this.ruleForm.shenfenzheng))){
