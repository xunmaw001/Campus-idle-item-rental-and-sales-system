...
import center from '@/views/center'
    import shangpinzujie from '@/views/modules/shangpinzujie/list'
    ...
    import shangpinzhonglei from '@/views/modules/shangpinzhonglei/list'
...
const routes = [{
	...
	path: '/shangpinxinxi',
        ...
        component: shangpinxinxi
          ...
          ,{
	path: '/shangpinzhonglei',
        name: '商品种类',
        component: shangpinzhonglei
      }
          ,{
	path: '/storeup',
        name: '我的收藏管理',
