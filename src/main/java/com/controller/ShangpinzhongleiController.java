...
public class ShangpinzhongleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ShangpinzhongleiEntity shangpinzhonglei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShangpinzhongleiEntity shangpinzhonglei, HttpServletRequest request){
        EntityWrapper<ShangpinzhongleiEntity> ew = new EntityWrapper<ShangpinzhongleiEntity>();
		PageUtils page = shangpinzhongleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shangpinzhonglei), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShangpinzhongleiEntity> wrapper = new EntityWrapper<ShangpinzhongleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shangpinzhongleiService.selectCount(wrapper);
